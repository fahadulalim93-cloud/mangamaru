  ...
  return (
    <div ref={readerRootRef} className="mr-root" style={{
      ...
      {pages.length > 0 && (
        <div style={{
          ...
          <div style={{
            ...
            background: "#dc2626", transition: "width 0.2s",
          }} />
        </div>
      )}
      ...
      <div ref={containerRef} style={{
        ...
        {loading && (
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100%" }}>
            <div style={{ width: "40px", height: "40px", border: "3px solid rgba(255,255,255,0.1)", borderTopColor: "#dc2626", borderRadius: "50%", animation: "spin 0.8s linear infinite" }} />
          </div>
        )}
        ...
        {error && (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", gap: "12px", color: "#fff" }}>
            ...
            <button onClick={() => navigate({ page: "manga-detail", id: mangaId } as any)}
              style={{ padding: "8px 16px", background: "#dc2626", borderRadius: "8px", color: "#fff", fontSize: "13px", fontWeight: 600, border: "none", cursor: "pointer" }}>
              Back to detail
            </button>
          </div>
        )}
      ...
      <style>{`
        ...
        .mr-nav-btn-active { background: rgba(30,136,255,0.2); color: #dc2626; }
      `}</style>
    </div>
  );
}
    ...
    <div style={{
      ...
      <div style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
        {prevChapter ? (
          <button onClick={() => goToChapter(prevChapter)} style={navBtn}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#dc2626" strokeWidth="2.5"><path d="M15 19l-7-7 7-7" /></svg>
        ...
        {nextChapter ? (
          <button onClick={() => goToChapter(nextChapter)} style={navBtn}>
            ...
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#dc2626" strokeWidth="2.5"><path d="M9 5l7 7-7 7" /></svg>
          </button>
        ) : (
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", padding: "4px 2px" }}>
        ...
        <button onClick={copyLink} title="Copy link" aria-label="Copy link"
          style={{
            width: "40px", height: "40px", background: copied ? "#dc2626" : "#1f1f23",
            border: `1px solid ${copied ? "#dc2626" : "#2e2e35"}`, borderRadius: "8px",
      ...
      <div style={{
        ...
        <button onClick={() => username ? setHasLikedChapter(!hasLikedChapter) : alert("Sign in to like")}
          style={{
            ...
            color: hasLikedChapter ? "#dc2626" : "#d4d4d8", fontSize: "13px", fontWeight: 600,
          }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <button onClick={toggleFollow}
            style={{
              background: "transparent", border: "none", cursor: "pointer",
              display: "flex", alignItems: "center", gap: "4px",
              color: isFollowing ? "#dc2626" : "#d4d4d8", fontSize: "13px", fontWeight: 600,
            }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                    <button onClick={() => handleLike(c.id)}
                      style={{ background: "transparent", border: "none", cursor: "pointer", color: c.hasLiked ? "#dc2626" : "#71717a", fontSize: "12px", fontWeight: 500, display: "flex", alignItems: "center", gap: "4px", padding: 0 }}>
      ...
      <div style={{ padding: "10px 12px", background: "#1f1f23", borderTop: "1px solid #3f3f46" }}>
        ...
        {text.trim() && (
          <button onClick={handleSubmit} disabled={submitting}
            style={{ marginTop: "6px", padding: "6px 16px", borderRadius: "6px", border: "none", cursor: "pointer", background: "#dc2626", color: "#fff", fontSize: "12px", fontWeight: 600 }}>
        ...
        {sortedChapters.slice(0, visibleCount).map((ch, i) => {
          ...
          return (
            ...
            >
              <div style={{ minWidth: 0, flex: 1 }}>
                <div style={{
                  color: isActive ? "#dc2626" : "#fff", fontSize: "13px", fontWeight: 600,
    ...
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
      ...
      <button onClick={() => onChange(!value)}
        style={{
          ...
          background: value ? "#dc2626" : "rgba(255,255,255,0.1)", position: "relative",
